...
function [final_nodes, final_fibers] = Triaxial_INP_Gen_STEP(file_loc,strain, l_fiber)   
load_file=file_loc;
...
edge_z_pos = find(final_nodes(:,4) > (side_lengthz/2 - 2.5) );
edge_z_neg = find(final_nodes(:,4) < (-1*side_lengthz/2 + 2.5) );
